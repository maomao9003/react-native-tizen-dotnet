...
class XHRExampleDownload extends React.Component {
  ...
  render() {
    const button = this.state.downloading ? (
      <View style={styles.wrapper}>
        <View style={styles.button}>
          <Text style={{color:'black'}}>Downloading...</Text>
        </View>
      </View>
    ) : (
      <TouchableHighlight
        ...
        <View style={styles.button}>
          <Text style={{color:'black'}}>Download 5MB Text File</Text>
        </View>
      </TouchableHighlight>
    );
    ...
    if (this.state.readystateHandler && !this.state.arraybuffer) {
      ...
      readystate = (
        <View>
          <Text style={styles.progressBarLabel} style={{color:'black'}}>
            responseText:{' '}
    ...
    return (
      <View>
        <View style={styles.configRow}>
          <Text style={{color:'black'}}>onreadystatechange handler</Text>
          <Switch
        ...
        <View style={styles.configRow}>
          <Text style={{color:'black'}}>onprogress handler</Text>
          <Switch
        ...
        <View style={styles.configRow}>
          <Text style={{color:'black'}}>download as arraybuffer</Text>
          <Switch
