      ...
      <View>
        <TouchableHighlight
          ...
          <View style={styles.button}>
            <Text style={{color:'black'}}>Set cookie</Text>
          </View>
        </TouchableHighlight>
        <TouchableHighlight
          style={styles.wrapper}
          ...
          <View style={styles.button}>
            <Text style={{color:'black'}}>Set cookie (EU)</Text>
          </View>
        </TouchableHighlight>
        <TouchableHighlight
          style={styles.wrapper}
          ...
          <View style={styles.button}>
            <Text style={{color:'black'}}>Get cookies</Text>
          </View>
        </TouchableHighlight>
        <TouchableHighlight
          style={styles.wrapper}
          ...
          <View style={styles.button}>
            <Text style={{color:'black'}}>Get cookies (EU)</Text>
          </View>
        </TouchableHighlight>
        <TouchableHighlight
          style={styles.wrapper}
          ...
          <View style={styles.button}>
            <Text style={{color:'black'}}>Clear cookies</Text>
          </View>
        </TouchableHighlight>
        <Text style={{color:'black'}}>{this.state.status}</Text>
        <TouchableHighlight
          style={styles.wrapper}
          onPress={this.refreshWebview.bind(this)}>
          <View style={styles.button}>
            <Text style={{color:'black'}}>Refresh Webview</Text>
          </View>
        </TouchableHighlight>
        <WebView
          ref="webview"
